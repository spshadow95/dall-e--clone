      ...
      <form className="mt-16 max-w-3xl" onSubmit={handleSubmit}>
        ...
        <div className="mt-5 flex gap-5">
          <button type="button"
            ...
            rounded-md text-sm  sm:w-auto w-full px-5 py-2.5
            text-center">
        ...
        <div className="mt-10">
          <p className="mt-2 text-[#666e75] text-[14px]">Once you have created the image you want, you can share it with others int the community</p>
          <button type="submit"
